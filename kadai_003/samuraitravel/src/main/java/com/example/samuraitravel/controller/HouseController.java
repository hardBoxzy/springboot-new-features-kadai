...
//            housePage = houseRepository.findAll(pageable);
    		...
    		Model model) 
    {
        ...
        if (userDetailsImpl != null) {
            ...
            Optional<Favorite> favorite = favoriteRepository.findFirstByUserAndHouse(user, house);
    ...
    public String registerReview(Model model,@PathVariable(name = "id") Integer houseId) {
    	House house = houseRepository.getReferenceById(houseId);
    	model.addAttribute("house", house); 
